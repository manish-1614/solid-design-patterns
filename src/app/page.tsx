...
export default function Home() {
  return (
    <div className="min-h-screen max-w-[88vw] flex flex-col gap-4 justify-center items-center bg-gradient-to-br from-zinc-50 via-white to-zinc-400 dark:from-zinc-950 dark:via-black dark:to-zinc-900">
      <div className="w-full px-3 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8 md:py-12 max-w-[100vw]">
        {/* Header */}
